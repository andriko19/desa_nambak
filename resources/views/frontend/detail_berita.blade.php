        ...
        <div class="container">
            <div class="row">
                ...
                <div class="author-box d-nlock d-sm-flex">
                    ...
                    <img loading="lazy" src="{{ URL::asset('assets/frontend/')}}/images/news/avator1.png" alt="author">
                    </div>
                ...
                <div id="comments" class="comments-area">
                    ...
                    <li>
                        ...
                        <img loading="lazy" class="comment-avatar" alt="author" src="{{ URL::asset('assets/frontend/')}}/images/news/avator1.png">
                        ...
                        <li>
                            <div class="comment d-flex">
                            <img loading="lazy" class="comment-avatar" alt="author" src="{{ URL::asset('assets/frontend/')}}/images/news/avator2.png">
                            <div class="comment-body">
                                <div class="meta-data">
                        ...
                        <img loading="lazy" class="comment-avatar" alt="author" src="{{ URL::asset('assets/frontend/')}}/images/news/avator3.png">
                        <div class="comment-body">
                            <div class="meta-data">
                ...
                <div class="sidebar sidebar-right">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="d-flex align-items-center">
                        <div class="posts-thumb">
                            <a href="#"><img loading="lazy" alt="img" src="{{ URL::asset('assets/frontend/')}}/images/news/news2.jpg"></a>
                        </div>
                        <div class="post-info">
                            <h4 class="entry-title">
                        ...
                        <li class="d-flex align-items-center">
                        <div class="posts-thumb">
                            <a href="#"><img loading="lazy" alt="img" src="{{ URL::asset('assets/frontend/')}}/images/news/news3.jpg"></a>
                        </div>
                        <div class="post-info">
                            <h4 class="entry-title">
